    ...
    public function cadastrarProduto($dados)
{
    try {
        ...
        // 3️⃣ Inserir na tabela estoque
        $sqlEstoque = "INSERT INTO estoque (id_produto, quantidade, tipo, id_loja)
                       VALUES (:id_produto, :quantidade, :tipo, :id_loja)";
