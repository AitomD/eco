...
<style>
    ...
    */
    ...
    .list-group-item-action.active {
        ...
        border-color: #fff; /* Remove bordas laterais do bootstrap */
    }
...
<main class="container py-4">
    ...
    <div class="row g-4">
        ...
        </div> <div class="modal p-4 fade" id="modalEditarDados" tabindex="-1" aria-labelledby="modalEditarDadosLabel" aria-hidden="true">
